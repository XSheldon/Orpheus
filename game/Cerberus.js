(function (window) {
    function Cerberus(CerberusName, imgCerberus, CAN_WIDTH) {
        this.initialize(CerberusName, imgCerberus, CAN_WIDTH);
    }
    ...
    Cerberus.prototype.initialize = function (CerberusName, imgCerberus) {
        ...
        Cerberus_COL_X = this.spriteSheet.getFrame(0).rect.width / 4;
    ...
    Cerberus.prototype.tick = function () {
        if (!this.isInIdleMode) {
            ...
            if (this.x >= this.CAN_WIDTH - (Cerberus_COL_X + 1) || this.x < (Cerberus_COL_X + 1)) {
            ...
            if (this.idleWaitTicker == 0) {
                ...
                // Hit testing the screen width, otherwise our sprite would disappear
                if (this.x >= this.CAN_WIDTH - (Cerberus_COL_X + 1)) {
